...
var o = (r, t) => hi(r, "name", { value: t, configurable: true });
var cr = (() => {
  ...
  return (u) => {
    for (var w = u.length, S = new Uint8Array((w - (u[w - 1] == "=") - (u[w - 2] == "=")) * 3 / 4 | 0), B = 0, $ = 0; B < w; ) {
      var j = r[u.charCodeAt(B++)], H = r[u.charCodeAt(B++)], ee = r[u.charCodeAt(B++)], ae = r[u.charCodeAt(B++)];
...
o(Se, "lerp");
function Nt(r, t, u, w, S) {
  return w + (r - t) / (u - t) * (S - w);
}
o(Nt, "map");
function hr(r, t, u, w, S) {
  return Pe(Nt(r, t, u, w, S), w, S);
}
o(hr, "mapc");
var _a;
var y = (_a = class {
...
var q = (_a2 = class {
  ...
  static fromHSL(t, u, w) {
    ...
    return new _a2(Math.round(j * 255), Math.round(H * 255), Math.round(ee * 255));
  }
  clone() {
...
function fr(r) {
  return r != null && (Tn.seed = r), Tn.seed;
}
o(fr, "randSeed");
function gt(...r) {
  return Tn.genAny(...r);
...
o(vr, "testLinePoint");
function Mn(r, t) {
  let u = r.p2.sub(r.p1), w = u.dot(u), S = r.p1.sub(t.center), B = 2 * u.dot(S), $ = S.dot(S) - t.radius * t.radius, j = B * B - 4 * w * $;
...
function yr(r, t) {
  ...
  return br(r, t.pts[0]) ? true : Rn(t, r.center);
}
...
var Re = (_a14 = class {
  ...
  numListeners(t) {
    var _a20;
    return ((_a20 = this.handlers[t]) == null ? void 0 : _a20.numListeners()) ?? 0;
  }
}, (() => {
  o(_a14, "EventHandler");
})(), _a14);
...
o(Fn, "downloadBlob");
var Bn = o((r) => r.match(/^data:\w+\/\w+;base64,.+/), "isDataURL");
...
var Tr = o((r) => {
  ...
  let t = { canvas: r.canvas, loopID: null, stopped: false, dt: 0, time: 0, realTime: 0, fpsCounter: new Vn(), timeScale: 1, skipTime: false, numFrames: 0, mousePos: new y(0), mouseDeltaPos: new y(0), keyState: new et(), mouseState: new et(), mergedGamepadState: new In(), gamepadStates: /* @__PURE__ */ new Map(), gamepads: [], charInputted: [], isMouseMoved: false, lastWidth: r.canvas.offsetWidth, lastHeight: r.canvas.offsetHeight, events: new Re() };
  function u() {
    return t.canvas;
  }
  o(u, "canvas");
  ...
  function ot() {
    ...
    for (let h of t.gamepads) {
      let x = navigator.getGamepads()[h.index], L = (r.gamepads ?? {})[x.id] ?? Ln[x.id] ?? Ln.default, me = t.gamepadStates.get(h.index);
...
var ho = o((r = {}) => {
  ...
  })(), w = r.scale ?? 1, S = r.width && r.height && !r.stretch && !r.letterbox;
  S ? (u.width = r.width * w, u.height = r.height * w) : (u.width = u.parentElement.offsetWidth, u.height = u.parentElement.offsetHeight);
  let B = u.width, $ = u.height, j = r.pixelDensity || window.devicePixelRatio;
  ...
  let ae = ee.getContext("2d", { willReadFrequently: true }), U = Tr({ canvas: u, touchToMouse: r.touchToMouse, gamepads: r.gamepads, pixelDensity: r.pixelDensity, maxFPS: r.maxFPS }), X = [], d = U.canvas().getContext("webgl", { antialias: true, depth: true, stencil: true, alpha: true, preserveDrawingBuffer: true });
  const _W = class {
    constructor(n, s, i = {}) {
  ...
  let v = (() => {
    let e = Ke(jn, Nn), n = W.fromImage(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)), s = r.width && r.height ? new De(r.width * j, r.height * j) : new De(d.drawingBufferWidth, d.drawingBufferHeight), i = null, a = 1;
    r.background && (i = q.fromArray(r.background), a = r.background[3] ?? 1, d.clearColor(i.r / 255, i.g / 255, i.b / 255, a)), d.enable(d.BLEND), d.enable(d.SCISSOR_TEST), d.blendFuncSeparate(d.SRC_ALPHA, d.ONE_MINUS_SRC_ALPHA, d.ONE, d.ONE_MINUS_SRC_ALPHA);
  ...
  const _ge = class {
    ...
    static fromArrayBuffer(n) {
      return new Promise((s, i) => re.ctx.decodeAudioData(n, s, i)).then((s) => new _ge(s));
    }
    static fromURL(n) {
      return Bn(n) ? _ge.fromArrayBuffer(Ur(n)) : Wt(n).then((s) => _ge.fromArrayBuffer(s));
    }
  };
  let ge = _ge;
  (() => {
  ...
  const _ue = class {
    ...
    static loaded(n) {
      let s = new _ue(Promise.resolve(n));
  ...
  function Pt(e, n = {}) {
    ...
    a.loop = !!n.loop, a.detune.value = n.detune ?? 0, a.playbackRate.value = n.speed ?? 1, a.connect(f), a.onended = () => {
      var _a20;
      G() >= ((_a20 = a.buffer) == null ? void 0 : _a20.duration) && c.trigger();
    ...
    return { stop() {
      ...
      var _a20;
      ((_a20 = a.buffer) == null ? void 0 : _a20.duration) && (M > a.buffer.duration || (i ? (a = k(a), m = l - M) : (a.stop(), a = k(a), m = s.currentTime - M, a.start(0, M), p = true, l = 0)));
    }, set speed(M) {
      ...
      var _a20;
      return ((_a20 = a.buffer) == null ? void 0 : _a20.duration) ?? 0;
    }, time() {
...
`)
  ...
  function fn(e = []) {
    let n = /* @__PURE__ */ new Map(), s = {}, i = new Re(), a = [], c = null, f = false, g = { id: Cr(), hidden: false, transform: new be(), children: [], parent: null, set paused(l) {
      ...
      let C = p.recursive ? this.children.flatMap(o(function R(G) {
  ...
  function Cs(e, n = {}) {
    function s(i) {
      ...
      return n.width || (i.width = a.width / (((_a20 = i.scale) == null ? void 0 : _a20.x) || 1)), i.height = a.height / (((_b = i.scale) == null ? void 0 : _b.y) || 1), a;
    }
  ...
  function ks(e, ...n) {
    ...
    A.events.onOnce("frameEnd", () => {
      ...
      }), A.root.clearEvents(), A.cam = { pos: null, scale: T(1), angle: 0, shake: 0, transform: new be() }, A.scenes[e](...n), r.debug !== false && Qn(), r.burp && Zn();
    });
  }
  o(ks, "go");
  function _s(e) {
  ...
  function $s(e, n) {
    ...
    let s = ht([Lt(n.pos ?? T(0))]), i = e.length, a = 0, c = null, f = null, g = null, m = null, l = o((b) => b.x + b.y * a, "tile2Hash"), p = o((b) => T(Math.floor(b % a), Math.floor(b / a)), "hash2Tile"), C = o(() => {
      ...
      for (de.set(F, 0); Y.length !== 0; ) {
        let Ae = (_a20 = Y.remove()) == null ? void 0 : _a20.node;
        if (Ae === _)
          break;
  ...
  const _yn = class {
    ...
    reverse() {
      return new _yn(this.target, this.source, this.displacement.scale(-1), this.resolved);
    }
    hasOverlap() {
...
`));
    ...
    te.paused && Be(() => {
      ...
      for (let i of A.logs) {
        ...
        a += `[time]${i.time.toFixed(2)}[/time]`, a += " ", a += `[${c}]${((_a20 = i.msg) == null ? void 0 : _a20.toString) ? i.msg.toString() : i.msg}[/${c}]`, n.push(a);
      }
...
`), font: zt, pos: T(e, -e), anchor: "botleft", size: 16, width: pe() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: J(127, 127, 127) }, info: { color: J(255, 255, 255) }, error: { color: J(255, 0, 127) } } });
  ...
  o(si, "drawDebug"), r.debug !== false && Qn(), r.burp && Zn();
  function ii(e) {
  ...
  let jt = true;
  U.run(() => {
    V.loaded || Ce() === 1 && !jt && (V.loaded = true, A.events.trigger("load")), !V.loaded && r.loadingScreen !== false || jt ? (Ge(), ri(), at()) : (te.paused || or(), ti(), Ge(), ni(), r.debug !== false && si(), at()), jt && (jt = false), A.events.trigger("frameEnd");
  });
  function ur() {
  ...
  o(ur, "updateViewport"), U.onHide(() => {
    ...
    r.backgroundAudio || re.ctx.resume();
  }), U.onResize(() => {
    if (U.isFullscreen())
      return;
    let e = r.width && r.height;
    e && !r.stretch && !r.letterbox || (u.width = u.offsetWidth * j, u.height = u.offsetHeight * j, ur(), e || (v.frameBuffer.free(), v.frameBuffer = new De(d.drawingBufferWidth, d.drawingBufferHeight), v.width = d.drawingBufferWidth / j, v.height = d.drawingBufferHeight / j));
  }), ur();
  ...
  if (r.plugins && r.plugins.forEach(rr), r.global !== false)
    for (let e in ke)
      window[e] = ke[e];
